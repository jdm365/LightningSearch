...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "include_dirs": [
            "/home/jakemehlman/.cache/uv/builds-v0/.tmpA2O8U2/lib/python3.12/site-packages/numpy/_core/include",
...
#define __PYX_HAVE__lightning_search
#define __PYX_HAVE_API__lightning_search
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "lightning_search" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "lightning_search"
extern int __pyx_module_is_main_lightning_search;
int __pyx_module_is_main_lightning_search = 0;

/* Implementation of "lightning_search" */
...
__Pyx_RefNannySetupContext("PyInit_lightning_search", 0);
  ...
  if (__pyx_module_is_main_lightning_search) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "lightning_search")) {
      if (unlikely((PyDict_SetItemString(modules, "lightning_search", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init lightning_search", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init lightning_search");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
